...
class CardOfDayScreen extends StatefulWidget with PlanetScreenMixin {
  ...
  _CardOfDayScreenState createState() =>
      _CardOfDayScreenState(AdManager.codInterstitialAdUnitId);
...
class _CardOfDayScreenState extends BaseAdScreenState<CardOfDayScreen> {
  late final CardOfDayBloc bloc;
  GlobalKey<FlipableLayoutCardState>? flipCardKey =
      GlobalKey<FlipableLayoutCardState>();

  _CardOfDayScreenState(String interstitialAdUnitId)
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    return questioned
                        ? StreamCardOfDay(
                            bloc: bloc,
                            onTap: (card, index) => createOnAdClosed(
                                () => _navigateToCardDescription(card, index)),
