...
class SavedDetailScreen extends StatefulWidget with PlanetScreenMixin {
  ...
  _SavedDetailScreenState createState() =>
      _SavedDetailScreenState(AdManager.spreadInterstitialAdUnitId);
...
class _SavedDetailScreenState extends BaseAdScreenState<SavedDetailScreen> {
  _SavedDetailScreenState(String interstitialAdUnitId)
    ...
    return AnimatedBuilder(
      ...
      child: Transform.rotate(
        ...
        child: GestureDetector(
          onTap: () => SavedDetailScreen.of(context).createOnAdClosed(() {
